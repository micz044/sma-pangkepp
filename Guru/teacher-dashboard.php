...
<head>
    ...
    <title>Dashboard Guru - Rekomendasi Bahan Pelajaran</title>
...
<body>
    ...
    <main class="animate__animated animate__fadeInUp">
        <section class="dashboard animate__animated animate__fadeIn">
            ...
            <p>Selamat datang di dashboard guru. Berikut adalah informasi penting yang dapat Anda akses:</p>
            <div class="card">
                <h2>Materi Pelajaran</h2>
                <a href="subjects-guru.php">Lihat Materi</a>
            </div>
            <div class="card">
                <h2>Tugas</h2>
                <a href="takes-guru.php">Lihat Tugas</a>
            </div>
            <div class="card">
                <h2>Nilai Siswa</h2>
                <a href="grade-guru.php">Lihat Nilai Siswa</a>
            </div>
            <div class="card">
                <h2>Rekomendasi Pelajaran</h2>
                <a href="recommendations-guru.php">Lihat Rekomendasi</a>
            </div>
            <div class="card">
                <h2>Profil</h2>
                <a href="guru-profile.php">Lihat Profil</a>
            </div>
        </section>
    </main>
